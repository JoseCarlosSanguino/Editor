...
<html lang="es">
   ...
   <body>
      ...
      <div class="container">
         ...
         <input type="hidden" id="modificar" name="modificar" value="<?php echo $modificar?>"/>
         <input type="hidden" name="checkpulsado" id="checkpulsado"  value="0"/>
           
         <div class="row textImagen">

            <div class="col-sm-12 d-flex justify-content-center text-center">
               <?php if(empty($row["image_header"])){?>
               <img id="imagen1" name="imagen1" src="Imagen2.jpg" style="position: relative;"  class="img-fluid w-100">
               <?php }else{?>
                  <img id="imagen1" name="imagen1" src="<?php echo $row["image_header"]?>" style="position: relative;"  class="img-fluid w-100">
               <?php }?>   
            </div>
            ...
            <textarea id="textarea1" name="textarea1"style=" background-color: transparent;display:none; " required >Inserte texto</textarea>
            <?php }else{?>
               <textarea id="textarea1" name="textarea1"style=" background-color: transparent; " required ><?php echo $row["text_header"]?></textarea>
            <?php }?> 
         </div>
         <br>
         <div class="row d-flex" >
            <div class="  col-lg-7 " >
               <div class="embed-responsive embed-responsive-21by9" >
                  ...
                  <?php }else{?>
                     <iframe id="iframe" name="iframe" class="embed-responsive-item" src="<?php echo $row["url_video"]?>"   frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen  ">
                  </iframe>
                  <?php }?>  
               ...
               <?php if(empty($row["url_video"])){?>
                  <input id="Video" name="Video" type="text" id="urlVideo" name="urlVideo" class="form-control" placeholder="Introduzca URL video" required>
               <?php }else{?>
                  <input id="Video" name="Video" type="text" id="urlVideo" name="urlVideo" class="form-control" value="<?php echo $row["url_video"]?>"placeholder="Introduzca URL video" required>
               <?php }?>  
            </div>
            <br>
            <div class=" col-lg-5 justify-content-center text-center" >
               <div class="textVideo">
                  <?php if (empty($row["textarea_1"])) {?>
                  <textarea id="textarea2" name="textarea2" style="background-color: transparent;border:none;overflow:hidden" required>Pulse aqui para insertar texto.
                  </textarea>
                  <?php }else{?>
                     <textarea id="textarea2" name="textarea2" style="background-color: transparent;border:none;overflow:hidden" required><?php echo $row["textarea_1"]?>.</textarea>

                  <?php }?> 
                  <?php if (empty($row["textarea_2"])) {?>
                  <textarea id="textarea3" name="textarea3" style=" background-color: transparent;border:none;overflow:hidden " required>Pulse aquí para insertar texto</textarea>
                  <?php }else{?>
                     <textarea id="textarea3" name="textarea3" style=" background-color: transparent;border:none;overflow:hidden " required><?php echo $row["textarea_2"]?>.</textarea>
                  <?php }?> 
         ...
         <div class="row" >
            <div  class=" col-lg-7 justify-content-center  position2 " >
               ...
               <input type="hidden" id="textoParrafo" name="textoParrafo" >
               <div id="introduction" name="introduction">
                  <?php if (empty($row["textarea_product"])) {?>
            ...
            <div class="  col-lg-5 justify-content-center  position    "  >
             <?php if (empty($row["img_product"])) {?>
               ...
               <img id="imagenpack" name="imagenpack" class="img-fluid imgProducto2" src="https://us-ms.gr-cdn.com/getresponse-wCxnR/photos/cdc77ef4-2424-4e3a-83f1-4b2fc9a0e270.png" alt="" width="170" height="144" style="visibility: hidden"/>
                ...
                <?php }else{?>
                 <img class="img-fluid imgProducto" id="imagen2" name="imagen2" src="<?php echo $row["img_product"]?>" alt="" height="auto" / >
